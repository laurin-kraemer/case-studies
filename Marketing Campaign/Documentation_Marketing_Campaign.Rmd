...
```
We concluded that a few variables are not statistically significant. Therefore, we trained the model again using only the relevant variables. hvjhgjhgjhgjhgjhgjh
